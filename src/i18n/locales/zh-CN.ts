const zhCN = {
  ...
  networkMonitor: {
    title: "网络监控",
    description: "查看本机物理接口、隧道与代理/VPN 的真实网络使用情况。",
    lastUpdated: "最后采集：{{value}}",
    actions: { startSession: "开始本次监控", stopSession: "停止本次监控", clear: "清空历史" },
    status: { running: "正在监控", disabled: "已停止", enabled: "已启用", connected: "已连接", disconnected: "未连接", stale: "显示的是上次成功数据" },
    onboarding: {
      title: "开始本地网络监控？",
      description: "ZxManager 默认不会采集网络用量，也不会创建网络历史数据库。",
      storageTitle: "本地存储与隐私",
      storageDescription: "启用后仅在此设备保存最多 7 天的接口流量桶。不会保存 MAC、远程地址、域名、URL、端口、数据包内容或命令行；v1 不提供应用归因。",
      start: "开始监控",
      notNow: "暂不开始",
    },
    capabilities: {
      degradedTitle: "部分能力不可用",
      applicationUnavailable: "v1 不使用 ETW 或估算值。应用流量归因明确不可用，接口和 VPN 隧道数据仍来自系统真实计数器。",
    },
    metrics: { downloadRate: "实时下载", uploadRate: "实时上传", sessionDownload: "本次下载", sessionUpload: "本次上传", activeInterfaces: "活跃接口", proxyVpn: "代理 / VPN" },
    realtime: { title: "最近 10 分钟", description: "睡眠、计数器重置或接口重建会显示为断点，不补零也不连接缺口。" },
    ...
    interfaces: {
      title: "网络接口",
      description: "物理接口与隧道分层展示，表格在窄窗口中独立滚动。",
      columns: { name: "接口", kind: "类型", layer: "层级", state: "状态", download: "下载", upload: "上传" },
      kinds: { ethernet: "以太网", wifi: "Wi-Fi", tunnel: "隧道", loopback: "回环", virtual: "虚拟", other: "其他" },
      states: { up: "运行中", down: "已停止", unknown: "未知" },
      waiting: "正在等待首个真实采样。",
      disabled: "当前会话未启用监控。",
    },
    layers: { physical: "物理接口", tunnel: "隧道", application: "应用" },
    proxy: { title: "代理与 VPN", description: "只保存配置类型和状态摘要，不保存服务器或 PAC URL。", systemProxy: "系统代理", vpn: "VPN 隧道", tunnelDownload: "隧道下载", vpnConnected: "VPN 已连接", proxyConfigured: "代理已配置", none: "未配置" },
    history: {
      title: "历史用量",
      description: "查询范围采用 [起始, 结束)，最大 7 天、最多 5000 点。",
      range: "时间范围",
      ranges: { "10m": "10 分钟", "1h": "1 小时", "24h": "24 小时", "7d": "7 天", custom: "自定义" },
      from: "开始时间",
      to: "结束时间",
      groupBy: "分组方式",
      groups: { time: "时间", interface: "接口", application: "应用", proxySession: "代理会话" },
      interfaceFilter: "接口筛选",
      applicationFilter: "应用筛选",
      proxyFilter: "代理 / VPN 筛选",
      all: "全部",
      vpn: "VPN 隧道",
      applicationUnavailable: "应用归因不可用",
      layers: "流量层级",
      layerDescription: "不同层级永不交叉合计；应用层在 v1 中不会产生伪数据。",
      query: "查询历史",
      loading: "正在查询本地历史…",
      empty: "此范围内没有可显示的历史流量。",
      invalidRange: "请选择有效且不超过 7 天的时间范围。",
      columns: { time: "时间", group: "分组", layer: "层级", download: "下载", upload: "上传" },
    },
    clear: { title: "清空本地网络历史？", description: "此操作会删除本地 SQLite 历史、实时缓存并重置累计基线，无法撤销。", confirm: "确认清空", success: "网络历史已清空" },
    toast: { started: "本次网络监控已开始", stopped: "本次网络监控已停止" },
    errors: {
      title: "网络监控暂不可用",
      codes: {
        unsupportedPlatform: "浏览器预览不提供主机网络采集，请使用 Tauri 桌面应用。",
        invalidRequest: "请求参数无效。",
        collectorUnavailable: "系统接口计数器采集失败。",
